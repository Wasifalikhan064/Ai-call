  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
        <h1 className="text-3xl font-bold text-center text-green-600 mb-6">AI Interview Calling System</h1>
        ...
        <button
          ...
          className={`w-full py-2 px-4 mb-6 text-white font-semibold rounded-md ${
            isCalling ? 'bg-green-300 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700'
          }`}
        >
            ...
            conversation.map((item, index) => (
              <div key={index} className="mb-4">
                <p className="text-gray-700">
                  <span className="font-semibold text-orange-600">AI:</span> {item.question}
                </p>
                <p className="text-gray-700">
                  <span className="font-semibold text-purple-600">User:</span> {item.response}
                </p>
              </div>
            ))
          )}
